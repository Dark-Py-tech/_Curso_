...
#         # Dibujamos los bloques del nivel actual
#         # Usamos (altura) para saber cuántos bloques usamos
#         print(f"Nivel {altura}: " + "■ " * altura)
        
#         bloques -= altura
    
#         # Verificamos si los bloques restantes alcanzan para el siguiente nivel
#         if bloques < altura + 1:
#             break 
...
# bloques = int(input("Ingrese el número de bloques: "))
# altura = 0
# ancho_pantalla = 50  # Un espacio fijo para centrar la pirámide
...
#         # Creamos la cadena de bloques para el nivel actual
#         cadena_bloques = "■ " * altura
        
#         # Centramos la cadena en base al ancho fijo que hemos definido
#         print(f"Nivel {altura:02d}: " + cadena_bloques.center(ancho_pantalla))
...
# linea = "-" * (ancho_etiqueta + ancho_decimal + ancho_binario + 4)

# print(linea)
# print(f"{'OPERACIÓN':<{ancho_etiqueta}} {'DECIMAL':>{ancho_decimal}} {'BINARIO':>{ancho_binario}}")
# print(linea)

# # Representación en binario
# print(f"{'Número 1:':<{ancho_etiqueta}} {numero1:>{ancho_decimal}} {numero1:06b}")
# print(f"{'Número 2:':<{ancho_etiqueta}} {numero2:>{ancho_decimal}} {numero2:06b}")
# print(linea)

# # Operaciones Bitwise
# # AND
# print(f"{'AND (&):':<{ancho_etiqueta}} {numero1 & numero2:>{ancho_decimal}} {numero1 & numero2:06b}")

# # OR
# print(f"{'OR (|):':<{ancho_etiqueta}} {numero1 | numero2:>{ancho_decimal}} {numero1 | numero2:06b}")

# # XOR
# print(f"{'XOR (^):':<{ancho_etiqueta}} {numero1 ^ numero2:>{ancho_decimal}} {numero1 ^ numero2:06b}")

# # NOT 
# resultado_not = ~numero1
# binario_not = f"{resultado_not & 0b111111:06b}"
# print(f"{'NOT (~numero1):':<{ancho_etiqueta}} {resultado_not:>{ancho_decimal}} {binario_not:>06}")
...
# print(f"{'Contenido de la lista original:':<40} {numbers}")  # Imprimiendo el contenido de la lista original.

# numbers[0] = 111
# print(f"{'Contenido de la lista después del cambio:':<40} {numbers}")  # Imprimiendo contenido de la lista con 111.

# numbers[1] = numbers[4]  # Copiando el valor del quinto elemento al segundo elemento.
# print(f"{'Contenido de la lista con intercambio:':<40} {numbers}")  # Imprimiendo contenido de la lista con intercambio.

# print(f"{'Longitud de la lista:':<40} {len(numbers)}")  # Imprimiendo la longitud de la lista.
...
#     mi_lista.append(random.randint(1,100000))

# mi_lista_copia = mi_lista[:] # copiando la lista para que las pruebas sean exactamente iguales
...
# print(f"Tiempo sin reducir el número de iteraciones: {round(fin - inicio, 4)} segundos")


# #############################################################
# # Solución reduciendo número de iteraciones por cada pasada
# #############################################################
...
#     for i in range(len(mi_lista_copia) - vueltas):
#         if mi_lista_copia[i] > mi_lista_copia[i + 1]:
#             intercambio = True  # ¡ocurrió el intercambio!
#             mi_lista_copia[i], mi_lista_copia[i + 1] = mi_lista_copia[i + 1], mi_lista_copia[i]
#     vueltas += 1
# # print(mi_lista_copia)
    
# fin = time.time()

# print(f"Tiempo reduciendo número de iteraciones: {round(fin - inicio, 4)} segundos")
...
# for numero in range(0, len(mi_lista)):
#    if mi_lista[numero] in nueva_lista:
#        continue
#    nueva_lista.append(mi_lista[numero])
# print(nueva_lista)
